...
namespace NexKutuphane.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260606113336_AddLoanTables2")]
    partial class AddLoanTables2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexKutuphane.Domain.Entities.Dolap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DolapAdi")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DolapKodu")
                    ...
                    b.Property<int>("YerlesimBolumuId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("DolapKodu")
                        .IsUnique()
                        .HasFilter("[DolapKodu] IS NOT NULL");

                    b.HasIndex("YerlesimBolumuId");
            ...
            modelBuilder.Entity("NexKutuphane.Domain.Entities.KitapKonum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("KitapId", "RafId")
                        .IsUnique();

                    b.ToTable("KitapKonumlari");
                });
            ...
            modelBuilder.Entity("NexKutuphane.Domain.Entities.YerlesimBolumu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NexKutuphane.Domain.Entities.Dolap", b =>
                {
                    b.HasOne("NexKutuphane.Domain.Entities.YerlesimBolumu", "YerlesimBolumu")
                        .WithMany("Dolaplar")
                        .HasForeignKey("YerlesimBolumuId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("YerlesimBolumu");
                });
            ...
            modelBuilder.Entity("NexKutuphane.Domain.Entities.KitapKonum", b =>
                {
                    b.HasOne("NexKutuphane.Domain.Entities.Kitap", "Kitap")
                        .WithMany("KitapKonumlari")
                        .HasForeignKey("KitapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NexKutuphane.Domain.Entities.Raf", "Raf")
                        .WithMany("KitapKonumlari")
                        .HasForeignKey("RafId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
